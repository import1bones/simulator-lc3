...
def parse_args():
    ...
    build_parser.add_argument(
        "--python-bindings", action="store_true", help="Build Python bindings"
    )
    build_parser.add_argument(
        "--pipeline", action="store_true", help="Build with pipeline extensions"
    )
    build_parser.add_argument(
    ...
    test_parser.add_argument(
        "--fast", action="store_true", help="Run tests in parallel"
    )
    ...
    clean_parser.add_argument(
        "--all", action="store_true", help="Clean everything including reports"
    )

    # Setup command
    setup_parser = subparsers.add_parser("setup", help="Set up development environment")
    setup_parser.add_argument(
        "--deps", action="store_true", help="Install dependencies only"
    )
